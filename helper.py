...
class Helper:
    ...
    def __init__(self):
        ...
        self.validation_directory = 'data/train/'
    ...
    def construct_data_generator(self, batch_size=128, validation_split=0.2, target_size=(224,224), shuffle=True):
    ...
    def save(self, model, evaluator, name):
